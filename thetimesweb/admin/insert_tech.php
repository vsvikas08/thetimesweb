<html>
  <head>
      <title>Insert new Tech News</title>
	  <script src="https://cloud.tinymce.com/stable/tinymce.min.js"></script>
   <script>tinymce.init({ selector:'textarea' });</script>
  </head>
<body>
<h4>Insert image at low size not more than 50kb. </h4>
<form action="insert_tech.php" method="post" enctype="multipart/form-data">
<table align="center" border="10" width="800">
  <tr>
    <td align="center" colspan="5" bgcolor="yellow"><h1> Insert new Tech News</h1></td>
  </tr>
...
if(isset($_POST['submit'])){
    ...
    if($title =='' or $content1 ==''){
		...
		move_uploaded_file($image_tmp1,"../images_tech/$image_name1");
		move_uploaded_file($image_tmp2,"../images_tech/$image_name2");
		
	$query="insert into tech
	(tech_title,tech_date,tech_img1,tech_content1,tech_img2,tech_content2) values('$title','$date','$image_name1','$content1','$image_name2','$content2')";
