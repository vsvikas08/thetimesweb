<html>
  <head>
      <title>Insert new Educational News</title>
...
<table align="center" border="10" width="800">
  <tr>
    <td align="center" colspan="5" bgcolor="yellow"><h1> Insert new Educational News</h1></td>
  </tr>
...
if(isset($_POST['submit'])){
	...
	if($image_type=="image/jpeg" or "image/jpg" or $image_type=="image/gif" or $image_type=="image/png"){
		...
		move_uploaded_file($image_tmp,"../images_edu/$image_name");
		}
		else{
	...
	(edu_title,edu_date,edu_img,edu_content) values('$title','$date','$image_name','$content')";
